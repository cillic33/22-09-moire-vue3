          ...
          <ul class="cart__list">
            <li class="cart__item product">
              ...
              <div class="product__counter form__counter">
                ...
                <!--                <label for="cartInput01">Количество</label>
                                <input type="text" value="1" name="count" id="cartInput01">-->
            ...
            <li class="cart__item product">
              ...
              <div class="product__counter form__counter">
                ...
                <!--                <input type="text" value="1" name="count" id="cartInput02">-->
            ...
            <li class="cart__item product">
              ...
              <div class="product__counter form__counter">
                ...
                <!--                <input type="text" value="1" name="count" id="cartInput03">-->
